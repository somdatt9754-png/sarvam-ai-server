...
app.post("/webhook", async (req, res) => {
  try {
    ...
    sarvamReply = sarvamReply.replace(/<think>[\s\S]*?<\/think>/gi, "").trim();

    if (!sarvamReply) {
      sarvamReply = "अभी जवाब उपलब्ध नहीं है।";
    }
    ...
    console.log("WhatsApp send response:", JSON.stringify(whatsappData, null, 2));
